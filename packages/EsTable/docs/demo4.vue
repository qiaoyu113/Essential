<template>
  <EsContainer title="EsTable height属性">
    <!-- 表格 -->
    <EsTable
      ref="EsTable"
      class="EsTable"
    ...
    >
      <template v-slot:op="scope">
        <el-button type="text" size="small" @click="click(scope)">
          按钮
        </el-button>
      </template>
    </EsTable>
  ...
  methods: {
    ...
    getData() {
      this.tableData = [
        ...
        { name: "小明3", mobile: "13000000000", city: "北京市" },
        { name: "小明4", mobile: "13000000000", city: "北京市" },
      ];
    },
    // 点击事件
    click(scope: any) {
