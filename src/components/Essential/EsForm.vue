    ...
    >
      ...
      >
        ...
        >
          ...
          <LazyCascader
            v-else-if="item.type === 'es-cascader'"
            ref="LazyCascader"
            v-model="listQuery[item.key]"
            filterable
            :placeholder="item.tagAttrs.placeholder || '请选择'"
...
import LazyCascader from '@/components/Essential/LazyCascader.vue'
